...
namespace LAT.WorkflowUtilities.String.Tests
{
    ...
    public class EncodeHtmlTests
    {
        ...
        public EncodeHtmlTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.String.EncodeHtml" + ", " + "LAT.WorkflowUtilities.String";
        }
        #endregion
        ...
        public void Given_PlainString_Then_EncodeSuccessfully()
        {
            ...
            //Test(s)
            Assert.AreEqual(expected, output["EncodedString"]);
        }
