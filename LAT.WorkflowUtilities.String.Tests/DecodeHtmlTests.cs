...
namespace LAT.WorkflowUtilities.String.Tests
{
    ...
    public class DecodeHtmlTests
    {
        ...
        public DecodeHtmlTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.String.DecodeHtml" + ", " + "LAT.WorkflowUtilities.String";
        }
        #endregion
        ...
        public void Given_EmptyString_Then_EmptyStringReturn()
        {
            ...
            //Test(s)
            Assert.AreEqual(expected, output["DecodedString"]);
        }
